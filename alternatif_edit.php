                ...
                <!-- <div class="row">
                   ...
                   <?php
                    ...
                    if(isset($_POST['update'])) {
                        ...
                        $result = mysqli_query($koneksi,"UPDATE alternatifhp SET merk_hp='$merek', thn_hp='$thn' WHERE idhp=$ids");
...
<div class="col-md-6">
    ...
    <div class="panel-heading">
                    ...
                    $result = mysqli_query($koneksi,"SELECT * FROM alternatifhp WHERE idhp='$_GET[idhp]'") or die (mysqli_error());
