                  ...
                  <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        ...
                        if(($aksi<>"") and ($id_normal<>"")){
                             mysqli_query($koneksi,"delete from normal where id_normal='$id_normal'") or die (mysqli_error());
                            ...
                            <div class="datatable table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        include "koneksi.php";
                                        $nomor = 0;
                                        $result = mysqli_query($koneksi,"SELECT * FROM normal, alternatifhp WHERE normal.idhp=alternatifhp.idhp") or die (mysqli_error());
