                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="alert alert-warning">
                            Hallo,
                            <br />
                            Selamat datang di web applikasi smartphone choicer. Didalam web ini Anda dibantu oleh sistem dalam menentukan smartphone apa yang akan anda beli. Dengan memasukkan kriteria kriteria tertentu, Anda akan langsung diberikan hasil smartphone apa yang cocok dengan keadaan Anda.
                            Thanks <br>
                            Best Regard's Muhammad Adam Nahdlotul Halimi
                            <br />
                        </div>
                    </div>
                </div>
