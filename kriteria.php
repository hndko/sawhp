                ...
                <div class="col-md-6">
                  <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        ...
                        $aksi = @$_GET['aksi'];
                        if(($aksi<>"") and ($id<>"")){
                             mysqli_query($koneksi,"delete from kriteria where id_kriteria='$id'") or die (mysqli_error());
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        include "koneksi.php";
                                        $nomor = 0;
                                        $result = mysqli_query($koneksi,"SELECT * FROM kriteria") or die (mysqli_error());
