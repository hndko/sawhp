                ...
                <div class="col-md-6">
                  <!--   Kitchen Sink -->
                    <div class="panel panel-default">
                        ...
                        $aksi = @$_GET['aksi'];
                        if(($aksi<>"") and ($id<>"")){
                             mysqli_query($koneksi,"delete from alternatifhp where idhp='$id'") or die (mysqli_error());
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        include "koneksi.php";
                                        $result = mysqli_query($koneksi,"SELECT * FROM alternatifhp") or die (mysqli_error());
